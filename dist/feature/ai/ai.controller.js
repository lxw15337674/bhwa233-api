...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Generate Google AI response' }),
    (0, swagger_1.ApiBody)({ type: type_1.GoogleChatRequest }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Returns the Google AI generated response'
    }),
    (0, common_1.Post)('google-chat'),
    openapi.ApiResponse({ status: 201, type: String }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [type_1.GoogleChatRequest]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "googleChat", null);
