...
export declare function getAllStockGroups(): Promise<string>;
export declare function getStockCodesByTag(tag: string): Promise<string>;
...
export declare function fetchCFFEXFuturesCodes(): Promise<FuturesData[]>;
