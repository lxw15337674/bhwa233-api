...
export declare function getCNMarketIndexData(): unknown;
export declare function getUSMarketIndexData(): unknown;
export declare function getHKMarketIndexData(): unknown;
export declare function getStockDetailData(symbol: string): Promise<string>;
export declare function getGzjc(): unknown;
export {};
